...
def _normalize_one(raw_item: dict[str, Any], auth_source: str) -> dict[str, Any] | None:
    ...
    normalized: dict[str, Any] = {
        ...
        "quota": raw_item.get("quota"),
        "limits_progress": raw_item.get("limits_progress"),
        "default_model_slug": raw_item.get("default_model_slug"),
        "restore_at": raw_item.get("restore_at"),
        "success": raw_item.get("success"),
        "fail": raw_item.get("fail"),
        "input_image_success": raw_item.get("input_image_success"),
        "input_image_fail": raw_item.get("input_image_fail"),
        "last_used_at": raw_item.get("last_used_at"),
        "last_input_image_used_at": raw_item.get("last_input_image_used_at"),
        "last_input_image_success_at": raw_item.get("last_input_image_success_at"),
        "cooldown_until": raw_item.get("cooldown_until"),
        ...
        "needs_refresh": raw_item.get("needs_refresh", True),
    }
